export const emailVerificationTemplate = (otp) => {
  return `
    ...
    <head>
        <meta charset="utf-8">
        <title>Email Verification - Cozen Societies</title>
    </head>
                        ...
                        <tr>
                            <td style="padding: 40px 30px; text-align: center;">
                                ...
                                <p style="color: #94a3b8; margin: 0 0 30px 0; font-size: 14px; line-height: 1.6;">
                                    Thank you for signing up for Cozen Societies Platform. Please use the OTP below to verify your email address.
                                </p>
